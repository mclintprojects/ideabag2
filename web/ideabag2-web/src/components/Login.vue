<template>
    <div class="appContainer">
        ...
        <img v-if="this.$store.getters.isLoggingIn" id="loadingCircle" src="https://samherbert.net/svg-loaders/svg-loaders/oval.svg" />
    </div>
</template>
    ...
    methods: {
        loginUser() {
            if (this.formData.email.length > 0 && this.formData.password.length > 0) {
                ...
                eventbus.showToast('One or more required fields is empty.', 'success');
            }
        }
    },
    activated() {
